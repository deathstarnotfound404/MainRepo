...
public class Rovar implements IDestroyable {
    ...
    public String toStringUI() {
        ...
        sb.append("  - tápanyag: ").append(this.tapanyag).append("\n");

        sb.append("  - evés hatékonyság: ");
        if(evesHatekonysag == 1) {
            sb.append("100%").append("\n");
        } else if (evesHatekonysag == 0.5) {
            sb.append("50%").append("\n");
        } else if(evesHatekonysag == 0.25) {
            sb.append("25%").append("\n");
        } else {
            sb.append("0%").append("\n");
        }
        ...
        if(aktivHatas) {
            sb.append("  - aktív hatás: ").append("VAN").append("\n");
        } else {
            sb.append("  - aktív hatás: ").append("NINCS").append("\n");
        }

        if (tudVagni) {
            sb.append("  - vághat: ").append("IGEN").append("\n");
        } else {
            sb.append("  - vághat: ").append("NEM").append("\n");
        }
