...
public class Teszt_10 extends BaseTest{
    ...
    @Override
    public void runTest() {
        log.append("[Test_10] - Gombafonal Növesztés - Irányítás, Nincs elég fonal\n" +
                "-------------------------------------------------------------------------------\n\n");
        ...
        while (!elvartParancsok.isEmpty()) {
            ...
            System.out.println("[Test_10 - Bemenet]\n\t> " + kovetkezoElvart);
    ...
    private void tesztWriteOut() {
        log.append("[Test_10] - Teszt vége\n");
        saveTestResult(log, "10");
    }
