...
public class Teszt_05 extends BaseTest{
    //Parancs > spreadSpora -t2 -g1 -gsz1; exit
    ...
    protected void inicializalas() {
        ...
        elvartParancsok.add("spreadSpora -t1 -g0 -gsz0");
    ...
    @Override
    public void runTest() {
        log.append("[Test_05] - Spóra szórása - Céltektonon Gombatest van\n" +
                "-------------------------------------------------------------------------------\n\n");
        ...
        while (!elvartParancsok.isEmpty()) {
            ...
            System.out.println("[Test_05 - Bemenet]\n\t> " + kovetkezoElvart);
    ...
    private void tesztWriteOut() {
        log.append("[Test_05] - Teszt vége\n");
        saveTestResult(log, "05");
    }
