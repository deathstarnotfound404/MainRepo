...
public class Teszt_18 extends BaseTest{
    ...
    protected void inicializalas() {
        ...
        t2.addSpora(new VagasGatloSpora());
    ...
    protected void parancsFeldolgozas(String parancs) {
        ...
        switch (command) {
            ...
            case "cutFonal":
                int rovarNum1 = Integer.parseInt(parts[1].substring(2)); // "-r0" -> 0
                int tektonNum1 = Integer.parseInt(parts[2].substring(2));

                Rovar rovar1 = rovarList.get(rovarNum1);
                Tekton kijeloltTekton = tektonList.get(tektonNum1);

                //Gombafonal kivétele a modellből
                GombaFonal kivalaztottFonal = null;
                for(GombaFonal gf : rovar1.getHelyzet().getKapcsolodoFonalak()) {
                ...
                if (rovar1 != null && kijeloltTekton != null && kivalaztottFonal != null) {
                    if(rovaraszList.get(0).fonalVagas(rovar1, kivalaztottFonal)) {
    ...
    @Override
    public void runTest() {
        log.append("[Test_18] - Spora Elfogyasztása - VagastGatlo Spora\n" +
                "-------------------------------------------------------------------------------\n\n");
        ...
        while (!elvartParancsok.isEmpty()) {
            ...
            System.out.println("[Test_18 - Bemenet]\n\t> " + kovetkezoElvart);
    ...
    private void tesztWriteOut() {
        log.append("[Test_18] - Teszt vége\n");
        saveTestResult(log, "18");
    }
