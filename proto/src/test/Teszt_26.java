...
public class Teszt_26 extends BaseTest{
    ...
    protected void inicializalas() {
        ...
        BenitoSpora spora = new BenitoSpora();
    ...
    protected void parancsFeldolgozas(String parancs) {
        ...
        switch (command) {
            case "moveRovar":
                ...
                int rovaraszNum = Integer.parseInt(parts[3].substring(4)); // "-rsz0" -> 0
                ...
                if (rovar != null && celTekton != null && rovarasz != null) {
                    if (rovarasz.rovarIranyitas(rovar, celTekton)) {
                        ...
                        if (g.rovarEves(rovar)) {
                            log.append(g.getName() + ": Sikeresen elfogyasztotta a " + rovar.getId() + ". azonosítójú rovart.\n");
                        } else {
                            log.append(g.getName() + ": Sikertelen rovar evés.");
                        }
    ...
    @Override
    public void runTest() {
        log.append("[Test_26] - Rovar Evés - GombaFonal\n" +
                "-------------------------------------------------------------------------------\n\n");
        ...
        while (!elvartParancsok.isEmpty()) {
            ...
            System.out.println("[Test_26 - Bemenet]\n\t> " + kovetkezoElvart);
