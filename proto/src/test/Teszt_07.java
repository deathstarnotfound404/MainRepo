...
public class Teszt_07 extends BaseTest{
    ...
    @Override
    public void runTest() {
        log.append("[Test_07] - GombaTest szintlépése\n" +
                "-------------------------------------------------------------------------------\n\n");
        ...
        while (!elvartParancsok.isEmpty()) {
            ...
            System.out.println("[Test_07 - Bemenet]\n\t> " + kovetkezoElvart);
    ...
    private void tesztWriteOut() {
        log.append("[Test_07] - Teszt vége\n");
        saveTestResult(log, "07");
    }
