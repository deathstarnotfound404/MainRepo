...
public class Teszt_04 extends BaseTest{
    ...
    public void runTest() {
        ...
        while (!elvartParancsok.isEmpty()) {
            ...
            System.out.println("[Test_04 - Bemenet]\n\t> " + kovetkezoElvart);
    ...
    private void tesztWriteOut() {
        log.append("[Test_04] - Teszt vége\n");
        saveTestResult(log, "04");
    }
