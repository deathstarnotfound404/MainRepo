...
public class Teszt_24 extends BaseTest{
    ...
    protected void inicializalas() {
        ...
        Tekton t3 = new Tekton(new FonalDefenderHatas());
    ...
    @Override
    public void runTest() {
        log.append("[Test_24] - Tekton Hatás - Fonal Defender Hatás\n" +
                "-------------------------------------------------------------------------------\n\n");
        ...
        while (!elvartParancsok.isEmpty()) {
            ...
            System.out.println("[Test_24 - Bemenet]\n\t> " + kovetkezoElvart);
    ...
    private void tesztWriteOut() {
        log.append("[Test_24] - Teszt vége\n");
        saveTestResult(log, "24");
    }
}
