...
public class Teszt_15 extends BaseTest{
    ...
    @Override
    public void runTest() {
        log.append("[Test_15] - Spora Elfogyasztása - Spora\n" +
                "-------------------------------------------------------------------------------\n\n");
        ...
        while (!elvartParancsok.isEmpty()) {
            ...
            System.out.println("[Test_15 - Bemenet]\n\t> " + kovetkezoElvart);
    ...
    private void tesztWriteOut() {
        log.append("[Test_15] - Teszt vége\n");
        saveTestResult(log, "15");
    }
