...
public class Teszt_08 extends BaseTest{
    ...
    @Override
    public void runTest() {
        log.append("[Test_08] - Gombafonal Növesztés - Irányítás, céltektonon van spóra\n" +
                "-------------------------------------------------------------------------------\n\n");
        ...
        while (!elvartParancsok.isEmpty()) {
            ...
            System.out.println("[Test_08 - Bemenet]\n\t> " + kovetkezoElvart);
    ...
    private void tesztWriteOut() {
        log.append("[Test_08] - Teszt vége\n");
        saveTestResult(log, "08");
    }
