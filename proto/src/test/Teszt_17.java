...
public class Teszt_17 extends BaseTest{
    ...
    @Override
    public void runTest() {
        log.append("[Test_17] - Spora Elfogyasztása - Benito Spora\n" +
                "-------------------------------------------------------------------------------\n\n");
        ...
        while (!elvartParancsok.isEmpty()) {
            ...
            System.out.println("[Test_17 - Bemenet]\n\t> " + kovetkezoElvart);
    ...
    private void tesztWriteOut() {
        log.append("[Test_17] - Teszt vége\n");
        saveTestResult(log, "17");
    }
