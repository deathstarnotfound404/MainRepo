...
public class Teszt_20 extends BaseTest{
    ...
    @Override
    public void runTest() {
        log.append("[Test_20] - Spora Elfogyasztása - Klonozo Spora\n" +
                "-------------------------------------------------------------------------------\n\n");
        ...
        while (!elvartParancsok.isEmpty()) {
            ...
            System.out.println("[Test_20 - Bemenet]\n\t> " + kovetkezoElvart);
    ...
    private void tesztWriteOut() {
        log.append("[Test_20] - Teszt vége\n");
        saveTestResult(log, "20");
    }
