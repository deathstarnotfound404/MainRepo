...
public class Teszt_02 extends BaseTest{
    ...
    @Override
    public void runTest() {
        log.append("[Test_02] - Spóra szórása - Sikeres szórás\n" +
                "-------------------------------------------------------------------------------\n\n");
        ...
        while (!elvartParancsok.isEmpty()) {
            ...
            System.out.println("[Test_02 - Bemenet]\n\t> " + kovetkezoElvart);
    ...
    private void tesztWriteOut() {
        log.append("[Test_02] - Teszt vége\n");
        saveTestResult(log, "02");
    }
