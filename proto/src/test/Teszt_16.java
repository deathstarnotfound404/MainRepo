...
public class Teszt_16 extends BaseTest{
    ...
    @Override
    public void runTest() {
        log.append("[Test_16] - Spora Elfogyasztása - Gyorsito Spora\n" +
                "-------------------------------------------------------------------------------\n\n");
        ...
        while (!elvartParancsok.isEmpty()) {
            ...
            System.out.println("[Test_16 - Bemenet]\n\t> " + kovetkezoElvart);
    ...
    private void tesztWriteOut() {
        log.append("[Test_16] - Teszt vége\n");
        saveTestResult(log, "16");
    }
